package com.example.imageviewsample1;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FactImages[0] = res.getDrawable(R.drawable.fact_one);
        FactImages[1] = res.getDrawable(R.drawable.fact_two);
        FactImages[2] = res.getDrawable(R.drawable.fact_three);
